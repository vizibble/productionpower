...
function update_gauges(_ref2) {
  ...
  var voltage = _ref2.voltage,
    current = _ref2.current;
  (_gauge_voltage = gauge_voltage) === null || _gauge_voltage === void 0 || _gauge_voltage.setOption({
    series: [{
      data: [{
        value: voltage,
        name: 'Voltage'
  ...
  (_gauge_current = gauge_current) === null || _gauge_current === void 0 || _gauge_current.setOption({
    series: [{
      data: [{
        value: current,
        name: 'Current'
...
/* global echarts */
var chart_voltage = null,
  chart_current = null;
var data_voltage = [],
  data_current = [];
function resize_line_charts() {
  var _chart_voltage, _chart_current;
  (_chart_voltage = chart_voltage) === null || _chart_voltage === void 0 || _chart_voltage.resize();
  (_chart_current = chart_current) === null || _chart_current === void 0 || _chart_current.resize();
}
      ...
      markLine: {
        ...
        label: {
          formatter: function formatter(params) {
            return "Threshold: ".concat(params.value).concat(unit);
          }
        },
        lineStyle: {
          color: 'red',
...
function update_voltage_current_live(row) {
  var _chart_voltage2, _chart_current2;
  var t = new Date().getTime();
  data_voltage.unshift([t, row.voltage]);
  data_current.unshift([t, row.current]);
  (_chart_voltage2 = chart_voltage) === null || _chart_voltage2 === void 0 || _chart_voltage2.setOption({
    series: [{
      data: data_voltage
    }]
  });
  (_chart_current2 = chart_current) === null || _chart_current2 === void 0 || _chart_current2.setOption({
    series: [{
      data: data_current
    }]
  });
...
module.exports = {
  update_voltage_current_data: update_voltage_current_data,
  update_voltage_current_live: update_voltage_current_live
};
...
var _require = __webpack_require__(/*! ./graph.js */ "./src/JavaScript/graphs_maps/graph.js"),
  update_voltage_current_data = _require.update_voltage_current_data,
  update_voltage_current_live = _require.update_voltage_current_live;
var _require2 = __webpack_require__(/*! ./gauge.js */ "./src/JavaScript/graphs_maps/gauge.js"),
  update_gauges = _require2.update_gauges,
  create_gauges = _require2.create_gauges;
  ...
  select_Button.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          selectedDevice = document.querySelector('input[name="device"]:checked');
          if (selectedDevice) {
            _context.next = 4;
            break;
          }
        ...
        case 21:
          ...
          console.error("Error fetching device data:", _context.t0);
    ...
    }, _callee, null, [[8, 21, 25, 30]]);
  })));

  // Listen for real-time telemetry updates
  socket.on("device_data", function (_ref2) {
    var device_id = _ref2.device_id,
      voltage = _ref2.voltage,
      current = _ref2.current;
